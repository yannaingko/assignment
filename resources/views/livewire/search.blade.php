...
@section('content')
            ...
            <div class="d-flex header-search mb-5">
                <div class="search-card">
                    <div class="input-group bg-white">
                        ...
                        <input type="text" class="search-input form-control" value="{{$input}}" name="search" placeholder="Search...">
                        <span class="search-icon">
                            <i class="bi bi-search "></i>  
                        </span>
                        </div>
                        <div>
                        <button type="button" class="btn dropdown-toggle d-btn" data-bs-toggle="dropdown">
                            Category
                            </button>
    ...
    <div class="container">
        <div class="h-content mb-3">
            ...
            <p><b>Found <span> <b class="sentence">{{$item->total()}} items</b></span>  in Total</b></p>
            <a href="#">View More <i class="bi bi-chevron-right"></i></a>
        </div>
